...
const ApproveRequest = ({
    ...
    return (
        <Fade in={true}>
            <Box sx={{
                width: '100%',
                maxHeight: '95vh',  // Limit maximum height to 95% of viewport height
                display: 'flex',
                        ...
                        <Grid item xs={12}>
                            ...
                            >
                                ...
                                <TextField
                                    ...
                                    placeholder="Please provide your comments regarding this approval..."
                                    variant="outlined"
                                    value={comment}
                                ...
                                >
                                    * Comment is required before approving the request
                                </Typography>
                            </Card>
                        </Grid>
                    </Grid>
                ...
                >
                    ...
                    >
                        ...
                        Please review all details before approval
                    </Typography>
