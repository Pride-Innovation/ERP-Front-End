        ...
        <Paper elevation={0} sx={{ borderRadius: 2, overflow: 'hidden' }}>
            ...
            <Box sx={{ p: 3 }}>
                <Typography variant="body1" sx={{ mb: 2, fontWeight: 500, color: '#1E293B' }}>
                    Deleting this commodity will:
                </Typography>
                <Box sx={{ ml: 2, pl: 2, mb: 3, borderLeft: `3px solid ${alpha(theme.palette.warning.main, 0.5)}` }}>
                    <Typography variant="body2" sx={{ mb: 1, color: 'text.primary' }}>
                        • Permanently remove the commodity and all its associated data
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1, color: 'text.primary' }}>
                        • Affect inventory and asset management records linked to this commodity
                    </Typography>
                    <Typography variant="body2" sx={{ color: 'text.primary' }}>
                        • Remove the commodity from all reports and classifications
                    </Typography>
                </Box>
                ...
                >
                    <Stack direction="row" spacing={2} alignItems="center">
                        ...
                        <Box>
                            ...
                            {commodity.groupName && (
                                <Typography variant="body2" color="text.secondary">
                                    Unit: {commodity.groupName}
                                </Typography>
                            )}
                            {commodity.assetType && (
                                <Typography variant="caption" color="text.secondary" sx={{ display: 'block', mt: 0.25 }}>
                                    Asset Type: {commodity.assetType.name}
                                </Typography>
                            )}
                        </Box>
                    </Stack>
