    ...
    <>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
          Manage commodity types, asset classifications, and inventory categories
        </Typography>
            ...
            >
              <Select
                ...
                renderValue={(value) => (
                  ...
                  >
                    {value === "all" ? "All Asset Types" : value}
                  </Typography>
                )}
                sx={{
              ...
              >
                <MenuItem value="all" sx={{ py: 1 }}>
                  <Typography variant="body2">All Asset Types</Typography>
                </MenuItem>

                {uniqueAssetTypes.length > 0 && <Divider sx={{ my: 0.5 }} />}

                {uniqueAssetTypes.map(assetType => (
                  <MenuItem key={assetType} value={assetType} sx={{ py: 1 }}>
                    <Typography variant="body2">{assetType}</Typography>
                  </MenuItem>
                ))}
              </Select>
            </FormControl>
