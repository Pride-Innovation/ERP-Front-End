        ...
        <Paper elevation={0} sx={{ borderRadius: 2, overflow: 'hidden' }}>
            ...
            <Box sx={{ p: 3 }}>
                <Typography variant="body1" sx={{ mb: 2, fontWeight: 500, color: '#1E293B' }}>
                    Deleting this title will:
                </Typography>
                <Box sx={{ ml: 2, pl: 2, mb: 3, borderLeft: `3px solid ${alpha(theme.palette.warning.main, 0.5)}` }}>
                    <Typography variant="body2" sx={{ mb: 1, color: 'text.primary' }}>
                        • Permanently remove the title and all its associated data
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1, color: 'text.primary' }}>
                        • Affect employees and users currently assigned to this title
                    </Typography>
                    <Typography variant="body2" sx={{ color: 'text.primary' }}>
                        • Remove the title from all organizational hierarchy records
                    </Typography>
                </Box>
                ...
                >
                    <Stack direction="row" spacing={2} alignItems="center">
                        ...
                        <Box>
                            ...
                            {title.reportsTo && (
                                <Typography variant="body2" color="text.secondary">
                                    Reports To: {title.reportsTo.name}
                                </Typography>
                            )}
                            {title.role && (
