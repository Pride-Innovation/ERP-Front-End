        ...
        <Box p={{ xs: 2, sm: 3 }} sx={{ maxWidth: 1600, mx: 'auto' }}>
            ...
            <Paper
                ...
                sx={{
                    ...
                    background: `linear-gradient(135deg, ${alpha('#4285F4', 0.04)} 0%, ${alpha('#4285F4', 0.01)} 100%)`,
                    display: 'flex',
                    alignItems: 'center',
            ...
            >
                <Box>
                    ...
                    <Typography variant="caption" color="text.disabled" mt={0.25} display="block">
                        Viewing data for: <strong>{branchName}</strong>
                    </Typography>
                </Box>
                <Chip
            ...
            <SectionLabel icon={<DashboardOutlinedIcon fontSize="small" />} label="Branch Overview" />
            <KpiSummaryCards />

            {/* ── 2. Asset Distribution + Active vs Disposed ──────── */}
            <SectionLabel icon={<AssessmentOutlinedIcon fontSize="small" />} label="Branch Asset Analytics" />
            ...
            {/* ── 3. Branch Requests ───────────────────────────────── */}
            <SectionLabel icon={<PendingActionsOutlinedIcon fontSize="small" />} label="Branch Requests" />
            <RequestsStatusBarChart />

            {/* ── 4. Stock Trend + Inventory Summary ──────────────── */}
