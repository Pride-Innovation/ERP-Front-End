                    ...
                    <CardContent sx={{ px: 3, py: 2.5 }}>
                        {loading ? (
                            <Box py={5} textAlign="center">
                                <CircularProgress size={28} sx={{ mb: 2, color: PRIMARY_COLOR }} />
                            ...
                            latestPendingRequests.length === 0 ? (
                                <Box py={5} textAlign="center">
                                    ...
                                    <Typography variant="subtitle1" color="text.primary" fontWeight={600} mb={0.5}>
                                        No Pending Requests
                                    </Typography>
                                    <Typography variant="body2" color="text.secondary" sx={{ maxWidth: 400, mx: 'auto' }}>
                                        There are currently no pending requests awaiting approval. All requests have been processed.
                                    </Typography>
                                </Box>
                            ) : (
                                <Stack spacing={2.5}>
