...
export const permissionsMock: IPermission[] = [
    ...
    { index: 19, id: 52, name: "READ_TRANSPORT" },
    { index: 20, id: 53, name: "CREATE_TRANSPORT" },
    { index: 21, id: 54, name: "DELETE_TRANSPORT" },
    { index: 22, id: 55, name: "UPDATE_TRANSPORT" },
    { index: 23, id: 56, name: "READ_INVENTORY" },
    { index: 24, id: 57, name: "CREATE_INVENTORY" },
    { index: 25, id: 58, name: "DELETE_INVENTORY" },
    { index: 26, id: 59, name: "UPDATE_INVENTORY" },
    { index: 27, id: 60, name: "READ_SETTING" },
    { index: 28, id: 61, name: "CREATE_SETTING" },
    { index: 29, id: 62, name: "DELETE_SETTING" },
    { index: 30, id: 63, name: "UPDATE_SETTING" },
    { index: 31, id: 64, name: "READ_AUDIT" },
    { index: 32, id: 65, name: "CREATE_AUDIT" },
    { index: 33, id: 66, name: "DELETE_AUDIT" },
    { index: 34, id: 67, name: "UPDATE_AUDIT" },
    { index: 35, id: 68, name: "READ_STORE" },
    { index: 36, id: 69, name: "CREATE_STORE" },
    { index: 37, id: 70, name: "DELETE_STORE" },
    { index: 38, id: 71, name: "UPDATE_STORE" },
